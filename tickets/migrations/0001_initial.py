    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('open', 'Otwarte'), ('in_progress', 'W trakcie'), ('pending_closure', 'Oczekuje na potwierdzenie zamknięcia'), ('closed', 'Zamknięte')], default='open', max_length=20)),
                ('sensitive_data_warning', models.BooleanField(default=False)),
